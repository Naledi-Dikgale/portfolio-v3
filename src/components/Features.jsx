...
//           <img src="Capture (1).png" alt="Capture1" className="w-full max-w-xs" />
//           <img src="Capture (2).png" alt="Capture2" className="w-full max-w-xs" />
//         </div>
//         <div className="flex justify-center items-center space-x-4">
//           <img src="Capture (3).png" alt="Capture3" className="w-full max-w-xs" />

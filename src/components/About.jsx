...
function About() {
  ...
  return (
    <section id="about" className={`h-full mx-auto pb-16 pt-24 ${theme === 'light' ? 'bg-primary text-secondary' : 'bg-gradient-to-r from-slate-800 via-slate-850 to-slate-900 text-primary'}`}>

...
function Intro() {
  ...
  return (
    <section className={`h-auto pt-32 md:pt-16 pb-12 p-6 flex flex-col items-center justify-center ${theme === 'light' ? 'bg-primary text-secondary' : 'bg-gradient-to-r from-slate-800 via-slate-850 to-slate-900 text-primary'}`}>

...
function Intro() {
  ...
  return (
    <section className={`p-6 flex flex-col items-center justify-center mt-4 ${theme === 'light' ? 'bg-primary text-secondary' : 'bg-gradient-to-r from-slate-800 via-slate-850 to-slate-900 text-primary'}`}>

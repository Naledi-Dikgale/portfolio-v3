...
const TestimonialCard = ({ img, name, job, country, description, theme }) => {
  return (
    <div className="testimonial-card  md:w-[70vw] top-2 bg-transparent shadow-lg rounded-lg flex flex-col md:flex-row w-[80vw] justify-center items-center">
      ...
      <div className="card-body flex justify-center items-center w-full md:w-3/4 text-lg ">
        <p className={`mt-4 p-[4%] scroll ${theme === "dark" ? "text-slate-600" : "text-slate-600"}`}>
          {description}
        </p>
      </div>
    </div>
